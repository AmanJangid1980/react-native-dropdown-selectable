[<img src="https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dropdown-selectable-demo.png">](https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dropdown-selectable-demo.png)

# react-native-dropdown-selectable
...
## Getting started
```js
npm install react-native-dropdown-selectable --save
```
or

```js
yarn add react-native-dropdown-selectable
```
### Demo

[<img src="https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dropdown-selectable-thumbnal.jpg">](https://youtu.be/FhTDR_Ad_14)
...
```js
  ...
  import { Dropdown } from 'react-native-dropdown-selectable';
...
```js
  ...
  import { MultiSelect } from 'react-native-dropdown-selectable';
  import AntDesign from '@expo/vector-icons/AntDesign';
...
```js
  import React, { useState } from 'react';
  import { StyleSheet } from 'react-native';
  import { SelectCountry } from 'react-native-dropdown-selectable';
